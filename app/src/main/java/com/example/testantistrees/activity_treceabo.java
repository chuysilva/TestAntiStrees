...
public class activity_treceabo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_treceabo);
    ...
    public void Siguiente(View view) {
        ...
        if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
            ...
            if(rb1.isChecked()){
                preguntaCasa4 = preguntaCasa + 1;
            }
            if(rb2.isChecked()){
                preguntaCasa4 = preguntaCasa + 2;
            }
            if(rb3.isChecked()){
                preguntaCasa4 = preguntaCasa + 3;
            }
            Intent sig = new Intent(this, activity_catorceabo.class);
            sig.putExtra("resultadoIntensidad", resultadoIntensidad);
            sig.putExtra("preguntaTrabajo", preguntaTrabajo);
            sig.putExtra("preguntaCasa", preguntaCasa4);
