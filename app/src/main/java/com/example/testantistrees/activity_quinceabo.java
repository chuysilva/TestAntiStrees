...
public class activity_quinceabo extends AppCompatActivity {
    ...
    public void Siguiente(View view) {
        ...
        if(rb1.isChecked() || rb2.isChecked() || rb3.isChecked()){
            ...
            int preguntaEscuela4 = 0;

            if(rb1.isChecked()){
                preguntaEscuela4 = preguntaEscuela + 1;
            }
            if(rb2.isChecked()){
                preguntaEscuela4 = preguntaEscuela + 2;
            }
            if(rb3.isChecked()){
                preguntaEscuela4 = preguntaEscuela + 3;
            }
            Intent sig = new Intent(this, activity_16.class);
            ...
            sig.putExtra("preguntaEscuela", preguntaEscuela4);
            startActivity(sig);
